...
public class OwnerService {
    ...
    public ReferencedWarning getReferencedWarning(final Integer id) {
        ...
        final UserState userUserState = userStateRepository.findFirstByUser(owner);
        ...
        final GateLog userGateLog = gateLogRepository.findFirstByUser(owner);
        if (userGateLog != null) {
        ...
        final Amenity amenityAmenity = amenityRepository.findFirstByAmenity(owner);
